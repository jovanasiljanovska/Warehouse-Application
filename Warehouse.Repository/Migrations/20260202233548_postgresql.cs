        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductInOrders_CustomerOrders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchaseProductInOrders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PurchaseProductInOrders_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PurchaseProductInOrders_PurchaseOrders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseProductInOrders_OrderId",
                table: "PurchaseProductInOrders",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseProductInOrders_ProductId",
                table: "PurchaseProductInOrders",
                column: "ProductId");
